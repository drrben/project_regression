...
```
 ...
 This models meets the validity postulates. The Adjusted R-squared of this model is 0.5748 > 0.4901 ( Adjusted R-squared of the first model). So we will keep the last model in the following.
